...
class Controls:
  ...
  def state_control(self, CS):
    ...
    CC.latActive = (self.active or self.mads_ndlob) and not CS.steerFaultTemporary and not CS.steerFaultPermanent and \
                     ...
                     CS.madsEnabled and (not CS.belowLaneChangeSpeed or
    ...
    CC.longActive = self.active and CS.cruiseState.enabled and not self.events.any(ET.OVERRIDE) and not self.events.any(ET.NO_ENTRY)
  ...
  def publish_logs(self, CS, start_time, CC, lac_log):
    ...
    if not self.read_only and (self.initialized or self.toyota_force_sng):
